...
PHP_REDIS_API zval *redis_parse_info_response(char *resp, zval *rv);
PHP_REDIS_API zval *redis_parse_client_list_response(char *resp, zval *rv);
...
PHP_REDIS_API zval *redis_sock_read_multibulk_reply_zval(INTERNAL_FUNCTION_PARAMETERS, RedisSock *redis_sock, zval *rv);
